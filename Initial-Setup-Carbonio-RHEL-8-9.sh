...
# ==== Check Static IP ====
echo
echo "[0/10] Checking network configuration..."
...
# ==== Carbonio Repository ====
echo
echo "[3/10] Configuring Carbonio repository..."
...
# ==== Hostname & Hosts ====
echo
echo "[5/10] Configuring hostname & hosts..."
...
# ==== DNSMASQ SETUP ====
echo
echo "[6/10] Configuring DNS using dnsmasq..."
...
# Generated by Carbonio setup script
...
echo "✅ dnsmasq configured: $DNSCONF"

sleep 3

# ==== Time Sync ====
echo
echo "[7/10] Configuring Chrony..."
...
# ==== PostgreSQL 16 ====
echo
echo "[10/10] Installing PostgreSQL 16..."
if [ "$RHEL_VERSION" -eq 8 ]; then
